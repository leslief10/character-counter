...
const ToggleButton = ({ initialTheme, onThemeChange }: ToggleButtonProps = {}): JSX.Element => {
  ...
  return (
    <button
      ...
      className="flex flex-row justify-center items-center w-8 h-8 rounded-md bg-antiflash-white dark:bg-gunmetal hover:cursor-pointer md:w-11 md:h-11 focus-visible:outline-lavander-floral outline-lavander-floral"
    >
